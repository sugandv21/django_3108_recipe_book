...
urlpatterns = [
    ...
    path("accounts/login/", auth_views.LoginView.as_view(template_name="recipe/layout/login.html"), name="login"),
    path("accounts/logout/", auth_views.LogoutView.as_view(template_name="recipe/layout/logged_out.html"), name="logout"),
